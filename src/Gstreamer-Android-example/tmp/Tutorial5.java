...
public class Tutorial5 extends CardboardActivity implements SurfaceHolder.Callback {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        */
        ...
        GstreamerRajawaliCardboardView rajawaliCardboardView = new GstreamerRajawaliCardboardView(this);
        setContentView(rajawaliCardboardView);
        setCardboardView(rajawaliCardboardView);

        rajawaliCardboardView.setOnTouchListener(new View.OnTouchListener() {
            @Override
        ...
        SurfaceHolder sh = rajawaliCardboardView.getHolder();
        sh.addCallback(this);
