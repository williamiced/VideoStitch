...
public:
    ...
    void validate()
    {
        ...
        else
        {
            ...
            {
                if (has_suffix(input, ".avi") || has_suffix(input, ".AVI") || has_suffix(input, ".mp4") || has_suffix(input, ".MP4"))
    ...
    for(;;)
    {
        ...
        if(view.empty())          // If there are no more images stop the loop
        {
            ...
            if( mode != CALIBRATED && !imagePoints.empty() )
                ...
                cout << "Somehow failed to getinto calibration... " << mode << ", " << imagePoints.empty() << endl;
            break;
        }
        //! [get_input]
        ...
        case Settings::CHESSBOARD:
            ...
            cout << "Find chessboard Corners? " << found << endl;
            break;
